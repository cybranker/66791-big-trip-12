...
const createTripEventEditTemplate = () => `<form class="trip-events__item  event  event--edit" action="#" method="post">
...
const createTripListTemplate = () => `<ul class="trip-days"></ul>`;

const createTripDayTemplate = () => `<li class="trip-days__item  day">
  <div class="day__info">
